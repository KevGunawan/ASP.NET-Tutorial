...
namespace JokesWebApplication.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("jokeID,jokeQuestion,jokeAnswer,jokeAuthor")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("jokeID,jokeQuestion,jokeAnswer,jokeAuthor")] Joke joke)
        {
            if (id != joke.jokeID)
            {
                return NotFound();
        ...
        {
          return (_context.Joke?.Any(e => e.jokeID == id)).GetValueOrDefault();
        }
    }
}
